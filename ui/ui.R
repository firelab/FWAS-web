...
shinyUI(fluidPage(
  tags$head(
    ...
    a("Tanner Finney - tfinney@fs.fed.us",href="mailto:tfinney@fs.fed.us"),br(),
  ...
  # column(2,br()),
    ...
    fluidRow(
      column(5,
            ...
            ("Enable to receive Watches Warnings and Advisories from the National Weather Service."),br(),a('Map of Active WWA',href='http://www.weather.gov/',target="_blank"))
